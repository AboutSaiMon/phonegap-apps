...
public class AccelerometerUi extends Page {
    ...
    private static AccelerometerUiUiBinder uiBinder = GWT.create(AccelerometerUiUiBinder.class);
	...
	Accelerometer.getCurrentAcceleration(new Callback() {
		...
		text.setHTML("Current Acceleration:<br/>X: " + accel.getX() + "<br/>Y: "
			+ accel.getY() + "<br/>Z: " + accel.getZ());
	    }
	...
	watchId = Accelerometer.watchAcceleration(new Callback() {
	    ...
	    @Override
	    public void onSuccess(Acceleration accel) {
		text.setHTML("Watch Acceleration:<br/>X: " + accel.getX() + "<br/>Y: "
			+ accel.getY() + "<br/>Z: " + accel.getZ());
	    }
